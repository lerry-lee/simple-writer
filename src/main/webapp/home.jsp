...
<div>
    <div class="site-banner">
        ...
        <div class="site-banner-main">
            <div class="layui-anim site-desc" style="font-family: panel-">
                <p class="web-font-desc">Reflective writing platform</p>
                <cite>When the autumn wind is bleak, it is scattered all over the sky,you see the four seasons of
                    reincarnation, it is my obsession
            ...
            <div class="site-version" style="font-family: panel-">
                <span>current version:1.3.5</span>
        ...
        <ul class="site-idea">
            ...
            <li>
                <fieldset class="layui-elem-field layui-field-title">
                    ...
                    <p>AcaWriter works by looking for specific hallmarks of good academic writingthat signal that
                        there's a significant connection being made, or an important
